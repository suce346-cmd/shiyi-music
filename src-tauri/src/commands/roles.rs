...
mod tests {
    ...
    fn auditor_prompts_have_vocal_consistency_and_mode_aware_params() {
        ...
        // 弧线扩充护栏：参数区间覆盖 10 种弧线
        for arc in ["阶梯上升 20-28", "渐进爆发 15-25", "U 型 25-35", "单峰 20-30", "回环 20-28"] {
            assert!(a.system_prompt.contains(arc), "auditor 参数缺弧线区间: {}", arc);
        }
    }
