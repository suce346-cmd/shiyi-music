...
const zh = {
  ...
  "settings.outputLang.desc": "方案、歌词与最终提示词包的输出语言；专家讨论始终为中文",
  "settings.outputLang.zh": "中文",
  "settings.outputLang.en": "English",
...
const en: Strings = {
  ...
  "settings.outputLang.desc": "Language of the plan, lyrics and final prompt pack; expert discussion stays Chinese",
  "settings.outputLang.zh": "中文",
  "settings.outputLang.en": "English",
