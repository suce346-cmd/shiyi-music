...
const zh = {
  ...
  "settings.outputLang": "产出语言",
  "settings.outputLang.desc": "三态：全中文 / 中文歌词+英文 Style / 全英文；专家讨论始终为中文",
  "settings.outputLang.zh": "全中文",
  "settings.outputLang.mix": "中文歌词 + 英文 Style",
  "settings.outputLang.en": "全英文",
...
const en: Strings = {
  ...
  "settings.outputLang": "Output Language",
  "settings.outputLang.desc": "Three modes: all-Chinese / Chinese lyrics + English Style / all-English; expert discussion stays Chinese",
  "settings.outputLang.zh": "All Chinese",
  "settings.outputLang.mix": "Chinese lyrics + English Style",
  "settings.outputLang.en": "All English",
